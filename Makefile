...
CFLAGS= ${SEC} ${WARN} -std=c99 -pedantic -O2 -I/usr/X11R6/include -I/usr/X11R6/include/freetype2 -DXINERAMA
LDFLAGS= -L/usr/X11R6/lib -lX11 -lXft -lXinerama -lfontconfig -Wl,-z,relro,-z,now -pie
